...
void print_cycle(int n, char *b, char mood)
{
    ...
    for (int i = 0; i < reps; i++)
    {
        ...
        gettimeofday(&t_start, NULL);
        sort_list(&temp_ptr_1, &temp_ptr_2, &ptr_res, &cnt_tmp1, &cnt_tmp2, &cnt_res);
        gettimeofday(&t_end, NULL);
    ...
    {
        printf("┣━━━━━━━━━━━━━━━╋━━━━━━━━━━━━━╋━━━━━━━━━━━━━╋━━━━━━━━━━━━━╋━━━━━━━━━━━━━╋━━━━━━━━━━━━━━━╋━━━━━━━━━━━━━━━┫\n");
        printf("┃               ┃%10ld ms┃%10ld ms┃%10ld ms┃%10ld ms┃%12ld ms┃%12ld ms┃\n",
            time_arr[0], time_list[0], time_arr[1], time_list[1], time_arr[2], time_list[2]);
        printf("┃%9d      ┃ ----------- ┃ ----------- ┃ ----------- ┃ ----------- ┃"
            " ------------- ┃ ------------- ┃\n", n);
        printf("┃               ┃%11ld b┃%11ld b┃%11ld b┃%11ld b┃%13ld b┃%13ld b┃\n",
